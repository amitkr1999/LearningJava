package com.company.Advance.Final_Practice;
...
public class GameService {
    ...
    private static final String SRC_COM_COMPANY_ADVANCE_FINAL_PRACTICE_WORD_TXT = "src/com.company/Advance/Final_Practice/word.txt";
    ...
    private List<String> getTheWords() throws FileNotFoundException {
        ...
        File wordsFile = new File(SRC_COM_COMPANY_ADVANCE_FINAL_PRACTICE_WORD_TXT);
