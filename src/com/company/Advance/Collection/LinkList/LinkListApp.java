package com.company.Advance.Collection.LinkList;
...
// what is link list?
// Element are linked with using pointer. Each element of the link list has the reference (address/pointer) to the next element of the link list